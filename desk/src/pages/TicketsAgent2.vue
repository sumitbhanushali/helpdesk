<template>
  <div class="flex-col">
    ...
    <ViewControls2 :filter="{ filters: filters, filterableFields: filterableFields.data }"
...
import { TicketsAgentList2 } from '@/components/ticket';
import { ViewControls2 } from '@/components';
