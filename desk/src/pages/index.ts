export { default as CLayout } from "./c-layout/CLayout.vue";
export { default as HRoot } from "./HRoot.vue";

export { default as AuthLogin } from "./auth/AuthLogin.vue";
export { default as AuthSignup } from "./auth/AuthSignup.vue";
export { default as AuthVerify } from "./auth/AuthVerify.vue";

export { default as KBPublic } from "./knowledge-base/KnowledgeBasePublic.vue";
export { default as KBHome } from "./knowledge-base/KnowledgeBasePublicHome.vue";
