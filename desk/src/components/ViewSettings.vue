...
import { FeatherIcon, FormControl, call, Autocomplete } from "frappe-ui";
...
async function updateColumnDetails() {
  ...
  await call(
    "helpdesk.helpdesk.doctype.hd_list_view_settings.hd_list_view_settings.update",
    {
...
async function resetToDefault() {
  await call(
    "helpdesk.helpdesk.doctype.hd_list_view_settings.hd_list_view_settings.reset_to_default",
    {
      doctype: props.doctype,
    }
  );
